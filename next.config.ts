...
const securityHeaders = [
  ...
  { key: "Permissions-Policy", value: "camera=(), microphone=(), geolocation=()" },
  {
    ...
    value: [
      ...
      "img-src 'self' data: blob: https://marshharriercowley.co.uk https://cdn.sanity.io https://*.cdninstagram.com https://*.fbcdn.net https://www.googletagmanager.com https://www.google.com https://googleads.g.doubleclick.net",
      "connect-src 'self' https://formspree.io https://api.sanity.io https://*.sanity.io wss://*.sanity.io https://www.googletagmanager.com https://www.google.com https://googleads.g.doubleclick.net",
