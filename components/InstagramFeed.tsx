...
// Placeholder images using existing pub photography.
// TODO: replace with Instagram Basic Display API — set NEXT_PUBLIC_INSTAGRAM_ACCESS_TOKEN
// and fetch https://graph.instagram.com/me/media?fields=id,media_url,permalink&limit=6
const PLACEHOLDER_IMAGES = [
  { src: "/images/marsh-harrier-pub-food.jpg",             alt: "Food at The Marsh Harrier" },
  { src: "/images/marsh-harrier-pub-outdoor-garden.webp",  alt: "The Marsh Harrier beer garden" },
  { src: "/images/marsh-harrier-pub-bar.jpg",              alt: "The Marsh Harrier bar" },
  { src: "/images/marsh-harrier-pub-room-bedroom.avif",    alt: "Guest bedroom" },
  { src: "/images/marsh-harrier-pub-sign-beautiful.webp",  alt: "The Marsh Harrier pub sign" },
  { src: "/images/marsh-harrier-pub-front.webp",           alt: "The Marsh Harrier exterior" },
];
